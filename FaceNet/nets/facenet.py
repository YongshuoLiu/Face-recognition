...
class mobilenet(nn.Module):
    def __init__(self, pretrained):
        ...
        if pretrained:
            state_dict = load_state_dict_from_url("backbone_weights_of_mobilenetv1.pth", model_dir="model_data",
                                                progress=True)
...
class inception_resnet(nn.Module):
    def __init__(self, pretrained):
        ...
        if pretrained:
            state_dict = load_state_dict_from_url("backbone_weights_of_inception_resnetv1.pth", model_dir="model_data",
                                                progress=True)
            self.model.load_state_dict(state_dict)
